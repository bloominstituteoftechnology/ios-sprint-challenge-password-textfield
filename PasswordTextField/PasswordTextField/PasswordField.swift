...
class PasswordField: UIControl {
    ...
    private let labelFont = UIFont.systemFont(ofSize: 11.0, weight: .semibold)
    ...
    private var passwordStrengthLabel: UILabel = UILabel()
    ...
    func setup() {
        ...
        // Constrain
        let strengthViewWidths = frame.width / 6
        ...
        NSLayoutConstraint.activate([
            ...
            weakView.widthAnchor.constraint(equalToConstant: strengthViewWidths),
            ...
            mediumView.widthAnchor.constraint(equalToConstant: strengthViewWidths),
            ...
            strongView.widthAnchor.constraint(equalToConstant: strengthViewWidths),
            ...
            passwordStrengthLabel.topAnchor.constraint(equalTo: textField.bottomAnchor, constant: standardMargin),
            passwordStrengthLabel.leadingAnchor.constraint(equalTo: strongView.trailingAnchor, constant: standardMargin),
            passwordStrengthLabel.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -standardMargin),
            passwordStrengthLabel.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -standardMargin)
        ...
        passwordStrengthLabel.text = PasswordStrength.weak.rawValue
        passwordStrengthLabel.font = labelFont
        passwordStrengthLabel.textColor = labelTextColor
    ...
    @objc private func showHideButtonToggled() {
        if passwordShouldShow == false {
    ...
    func strengthOf(_ password: String) -> PasswordStrength {
        ...
        passwordStrengthLabel.text = strength.rawValue
