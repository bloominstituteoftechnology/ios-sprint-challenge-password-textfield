...
class PasswordField: UIControl  {
  ...
  fileprivate func setUpContainerView() {
    ...
    NSLayoutConstraint.activate([
      self.topAnchor.constraint(equalTo: topAnchor, constant: 64),
      self.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -64)
    ])
  }
  ...
  @objc func handleEye() {
    ...
    showHideButton.setImage(textField.isSecureTextEntry ?
                              UIImage(named: "eyes-closed") :
                              UIImage(named: "eyes-open") , for: .normal)
  ...
  public func textFieldShouldReturn(_ textField: UITextField) -> Bool {
    if UIReferenceLibraryViewController.dictionaryHasDefinition(forTerm: textField.text!) {
      print("Hello")
    }
