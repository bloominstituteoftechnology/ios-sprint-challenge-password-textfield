...
//    }
    ...
    @IBAction func passwordValueChanged(_ passwordTextField: PasswordField) {
        print("Password: \(passwordTextField.password)")
        print("Strength: \(passwordTextField.strength.rawValue)")
    }
}
